...
work <- tribble(
    ...
    "Ministry of Foreign Affairs and Trade", "Economist", "October", 2019, "August", 2022, "Wellington", "Working widely with domestic and international agencies and stakeholders to deliver on projects, such as the CPTPP three-year review, the trade evautation frame work and paper, and assessing global trade vulnerabilities,",
    "Ministry of Foreign Affairs and Trade", "Economist", "October", 2019, "August", 2022, "Wellington", "Regularly communicating analysis and findings to different stakeholders, tailoring to audiences so it can be better understood and more impactful.",
    "Ministry of Foreign Affairs and Trade", "Economist", "October", 2019, "August", 2022, "Wellington", "Out-of-cycle promotion for recognised contribution to team deliverables",
    ...
    "Ministry of Social Development", "Analyst", "April", 2018, "September", 2019, "Wellington", "Worked with the Chief Economist to developed a model that more accurately estimated the gender pay gap, and Augusted 2022 findings to senior leadership.",
